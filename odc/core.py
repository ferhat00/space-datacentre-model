"""
odc.core — calibrated physics + finance engine (faithful port of v2)
====================================================================
This module is the unchanged, SemiAnalysis-calibrated heart of the model. The
functions here are a byte-faithful port of v2 `odc_model.py` so that the SA26
reproduction stays within ~2% of the published anchors (regression-guarded in
tests/). New v3 capability lives in the sibling modules; `core` is deliberately
conservative.
