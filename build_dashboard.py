...
# --------------------------------------------------------------- slider schema
# [field, label, unit, min, max, step, kind, note] -- single source of truth in odc.schema
# (shared verbatim with the Streamlit app so the two UIs can never drift). Imported above.
